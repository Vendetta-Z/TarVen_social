...
class Posts_views:
    ...
    def create_post(self):
        ...
        Post = Posts_services.createNewPost(
            self, postFileInRequest, postDescription, postTitle, postPreview
        )
    ...
    def Search(self):
        ...
        searchParams = self.GET.get('search_param')
        return Posts_services.search(self, searchParams)
    #TODO Убрать нахрен отсюда всю логику для поиска , сделать колосальный рефакторинг и реструктуризацию проект. Задолбался сам с себя охреневать....